<?>function send_mobile_notification_request($user_mobile_info, $payload_info)
  {
    ...
    if ($user_device_type == "iOS") {
      ...
      $apns = stream_socket_client('ssl://' . $apns_port, $error, $error_string, 2, STREAM_CLIENT_CONNECT, $stream_context);
    ...
    @fclose($apns);
      ...
      // API acces key from Google API's console
      ...
      (
        ...
        'tickerText'  => 'Ticker texte here .Tickertext',
        'vibrate'     => 1,
        'sound'       => 1,
  ...
  function create_payload_json($message) {
    //badge icon to show at users ios app icon after receveid notification
    $badge = "0";
    $sound = 'default';
    $payload = array();
